"""
Transport-independent audio duplex protocols and reference adapters.

Audio flows into the application (user speech) and out (model speech).
These protocols are independent of Realtime and GPT-Live session semantics.
They define the two ends of the channel, and each adapter codifies the audio
