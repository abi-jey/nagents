...
test("manual models outside the catalog remain valid without changing other draft fields", () => {
  const draft = createDraft({ model: "manual/not-in-catalog", agent: "build", shell_timeout: 30, max_output: 16384, max_file_bytes: 1048576, max_tool_rounds: 37, max_subagent_depth: 2 });
